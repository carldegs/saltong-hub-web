  ...
  >
    ...
    <div className="p-4">
      <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 transition-all duration-300 lg:group-hover:-translate-y-10">
        ...
        <p className="m-0 max-w-lg leading-tight text-neutral-400">
          {pill && (
            <span
              className={cn(
                "mr-1 inline-block rounded-full bg-teal-200 px-2 py-0.5 text-xs font-bold text-neutral-700 dark:bg-teal-900 dark:text-neutral-300",
                pillClassName
              )}
            >
              {pill}
      ...
      >
        <Button
          ...
          asChild
          size="sm"
          className="pointer-events-auto -ml-2 p-0"
        >
          <a href={href}>
            {cta}
